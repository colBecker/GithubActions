[![Run App ColeBecker](https://github.com/colBecker/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/colBecker/GithubActions/actions/workflows/run-app.yaml)
